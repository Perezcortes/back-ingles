<?php
require_once __DIR__ . '/../models/TemplateMultipleChoiceCloze.php';

class TemplateMultipleChoiceClozeController
{
    // Listar activos
    public static function getAll()
    {
        try {
            $model = new TemplateMultipleChoiceCloze();
            $items = $model->obtenerTodos();
            http_response_code(200);
            echo json_encode($items);
        } catch (Exception $e) {
            self::sendError(500, "Error al obtener los registros de template_multiple_choice_cloze.", $e);
        }
    }
    ...
    public static function getOne($id)
    {
        ...
        try {
            ...
            if ($item) {
                ...
                self::sendError(404, "Plantilla no encontrada.");
            }
        } catch (Exception $e) {
        ...
        try {
            ...
            if ($creado) {
                ...
                echo json_encode([
                    ...
                    "template_multiple_choice_cloze" => [
                        "title" => $title,
                        "instruction" => $instruction,
                        "topic" => $topic,
                        "id_level" => (int)$data['id_level'],
        ...
        try {
            ...
            if ($actualizado) {
                ...
                echo json_encode([
                    ...
                    "template_multiple_choice_cloze" => $nuevo
                ]);
            } else {
        ...
        try {
            ...
            if ($deleted) {
                ...
                echo json_encode([
                    ...
                    "template_multiple_choice_cloze" => $item
                ]);
            } else {
        ...
        try {
            ...
            if ($restored) {
                ...
                echo json_encode([
                    ...
                    "template_multiple_choice_cloze_id" => (int)$id
                ]);
            } else {
