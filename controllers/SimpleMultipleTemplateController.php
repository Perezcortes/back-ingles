<?php
require_once __DIR__ . '/../models/SimpleMultipleTemplate.php';

class SimpleMultipleTemplateController
{
    // Listar activos
    public static function getAll()
    {
        try {
            $model = new SimpleMultipleTemplate();
    ...
    public static function create($data)
    {
        ...
        if (trim($data['title']) === '' || trim($data['instruction']) === '') {
            http_response_code(400);
            echo json_encode(["error" => "Los campos 'title' e 'instruction' no pueden ser vacíos"]);
            return;
        }
        ...
        try {
            ...
            if ($actualizado) {
                ...
                echo json_encode([
                    ...
                    "simple_multiple_template" => $nuevo
                ]);
            } else {
        ...
        try {
            ...
            if ($restored) {
                ...
                echo json_encode([
                    ...
                    "simple_multiple_template_id" => (int)$id
                ]);
            } else {
