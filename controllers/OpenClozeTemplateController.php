<?php
require_once __DIR__ . '/../models/OpenClozeTemplate.php';

class OpenClozeTemplateController
{
    // Listar activos
    public static function getAll()
    {
        try {
            $model = new OpenClozeTemplate();
            $items = $model->obtenerTodos();
            http_response_code(200);
            echo json_encode($items);
        } catch (Exception $e) {
            self::sendError(500, "Error al obtener los registros de open_cloze_template.", $e);
        }
    }
    ...
    public static function getOne($id)
    {
        ...
        try {
            ...
            if ($item) {
                ...
                self::sendError(404, "Plantilla de open cloze no encontrada.");
            }
        } catch (Exception $e) {
    ...
    public static function create($data)
    {
        ...
        try {
            ...
            if ($creado) {
                ...
                echo json_encode([
                    "message" => "Plantilla de open cloze creada exitosamente.",
                    "open_cloze_template" => [
                        "title" => $title,
                        "instruction" => $instruction,
                        "topic" => $topic,
    ...
    public static function update($id, $data)
    {
        ...
        try {
            ...
            if ($actualizado) {
                ...
                http_response_code(200);
                echo json_encode([
                    "message" => "Plantilla de open cloze actualizada exitosamente.",
                    "open_cloze_template" => $nuevo
                ]);
            } else {
