...
Route::get('/levels/getOne/{id}', [LevelController::class, 'getOne'], [AuthenticationMiddleware::class, 'check']);
...
Route::post('/students/logout', [StudentLoginController::class, 'logout'], [AuthenticationMiddleware::class, 'check']);
